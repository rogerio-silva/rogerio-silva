...
| Repositório | O que é |
|---|---|
| [`A2C-LoVQI`](https://github.com/rogerio-silva/A2C-LoVQI) | Aprendizado por reforço profundo para posicionar VANTs como gateways LoRaWAN (artigo SBrT 2024) |
| [`sliced-ns3-lorawan-module`](https://github.com/rogerio-silva/sliced-ns3-lorawan-module) | Módulo LoRaWAN do ns-3 estendido com suporte a *network slicing* |
| [`lorawan-gym`](https://github.com/rogerio-silva/lorawan-gym) | Cenários de simulação integrando ns-3, OpenAI Gym, LoRaWAN e NR-5G |
| [`non3GPP_IoT_simulations`](https://github.com/rogerio-silva/non3GPP_IoT_simulations) | Simulações e datasets do artigo *Dynamic resources allocation in non-3GPP IoT networks involving UAVs* |
| [`lorawan-class-c`](https://github.com/rogerio-silva/lorawan-class-c) | Implementação de dispositivos finais Classe C no módulo LoRaWAN do ns-3 |
| [`density-dev-distrib`](https://github.com/rogerio-silva/density-dev-distrib) | Distribuição de dispositivos IoT orientada por densidade |
...
- **C / C++** — [`c_yt_course`](https://github.com/rogerio-silva/c_yt_course) · [`aula-C-20250220`](https://github.com/rogerio-silva/aula-C-20250220)
- **Java e POO** — [`MeAu_PET`](https://github.com/rogerio-silva/MeAu_PET) · [`java-crud`](https://github.com/rogerio-silva/java-crud) · [`java-web-servlet`](https://github.com/rogerio-silva/java-web-servlet) · [`aula_Springboot_Flyway`](https://github.com/rogerio-silva/aula_Springboot_Flyway)
- **Redes** — [`aula_instalando_ns3`](https://github.com/rogerio-silva/aula_instalando_ns3) · [`sockets-computer-networking`](https://github.com/rogerio-silva/sockets-computer-networking)
- **Ferramentas** — [`git-basico`](https://github.com/rogerio-silva/git-basico) · [`update-ubuntu`](https://github.com/rogerio-silva/update-ubuntu)
...
<!--
  ...
  A instância pública (github-readme-stats.vercel.app) está com o deployment PAUSADO
  (HTTP 503 / DEPLOYMENT_PAUSED), então estes cards apareceriam quebrados.
  Para reativá-los, faça fork de https://github.com/anuraghazra/github-readme-stats,
  faça deploy próprio na Vercel (grátis, com um PAT em PAT_1) e troque o domínio abaixo.

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://SEU-DEPLOY.vercel.app/api?username=rogerio-silva&show_icons=true&rank_icon=github&locale=pt-br&theme=tokyonight&hide_border=true">
  <img alt="Estatísticas do GitHub de Rogério S. Silva" src="https://SEU-DEPLOY.vercel.app/api?username=rogerio-silva&show_icons=true&rank_icon=github&locale=pt-br&hide_border=true">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://SEU-DEPLOY.vercel.app/api/top-langs/?username=rogerio-silva&layout=compact&langs_count=8&locale=pt-br&theme=tokyonight&hide_border=true">
  <img alt="Linguagens mais usadas por Rogério S. Silva" src="https://SEU-DEPLOY.vercel.app/api/top-langs/?username=rogerio-silva&layout=compact&langs_count=8&locale=pt-br&hide_border=true">
</picture>
...
<!--
=====================================================================
ARQUIVO HISTÓRICO — versões anteriores deste perfil. Não apagar.
=====================================================================
